...
from bookkeeper.common import timeout
...
def wrap_method(func, default_retry=None, default_timeout=None):
    ...
    For example::
        ...
        import bookkeeper.common.method
        ...
        wrapped_get_topic = bookkeeper.common.method.wrap_method(
    ...
    * The final ``get_topic_with_timeout_and_retry`` is called passing through
    ...
    Args:
        ...
        default_retry (Optional[bookkeeper.common.Retry]): The default retry
            strategy. If ``None``, the method will not retry by default.
        default_timeout (Optional[bookkeeper.common.Timeout]): The default
